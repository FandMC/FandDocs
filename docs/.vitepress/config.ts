          ...
          '/cn/api/': [
            {
              ...
              items: [
                ...
                { text: '配方', link: '/cn/api/recipes' },
                { text: '战利品表', link: '/cn/api/loot' },
                { text: '进度', link: '/cn/api/advancements' },
                { text: '附魔', link: '/cn/api/enchantments' },
          ...
          '/en/api/': [
            {
              ...
              items: [
                ...
                { text: 'Recipes', link: '/en/api/recipes' },
                { text: 'Loot Tables', link: '/en/api/loot' },
                { text: 'Advancements', link: '/en/api/advancements' },
                { text: 'Enchantments', link: '/en/api/enchantments' },
